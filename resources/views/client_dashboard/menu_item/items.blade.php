...
<div class="content">
    ...
    <div class="cards grid grid-cols-1 lg:grid-col-3 md:grid-cols-3 gap-4 place-items-center lg:place-items-stretch h-auto w-full lg:w-[1050px] mx-auto my-6">
        ...
        <div class="block place-items-center self-stretch p-2 w-full bg-gray-700 rounded-xl border border-gray-100">
            <a href="{{route('dashboard.items.edit' , $item->id)}}">
                <div class="grid place-items-center text-center mb-2  max-w-xs rounded-lg ">
                    <h2 class="text-[30px] font-bold text-gray-50">{{ $item->name }}</h2>
                </div>
